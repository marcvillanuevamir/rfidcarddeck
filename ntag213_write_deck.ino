...
int numCards = 30;  // number of cards in the deck
int number = 1;     // counter
//String text = "";   // string holder
...
void loop() {
  ...
  if (number <= numCards) {
    ...
    Serial.print(F("MIFARE_Ultralight_Write() OK: "));
    Serial.println(text);
    number++;
  } else if (number == numCards) {
    Serial.println("Card deck complete; continue to start writing new deck...");
    number = 1;
  }
